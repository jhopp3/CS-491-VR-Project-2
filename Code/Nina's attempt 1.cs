...
public class Planet
{
    long rad, rad_orbit, mass;
    double time_orbit; //Double because it should be a fraction of an earth's year
    string p_name, star_name, discovered, texture;
	public Planet()
	{
	}
...
public class Star
{
    long rad, luminosity, d_from_sun;
